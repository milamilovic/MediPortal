...
namespace ZdravoCorp.HealthInstitution.Core.Users.Model
{
    public class Patient : INotifyPropertyChanged
    {
        ...
        [JsonConstructor]
        public Patient(string username, string password, int id, bool isBlocked, List<TimeSlot> busyTimeSlots, MedicalRecord medicalRecord)
        {
            _username = username;
            _password = password;
            _id = id;
        ...
        {
            Patient[] patients = LoadPatients("../../../Data/PatientInfo/PatientData.json");
        ...
        public static void SavePatients(Patient[] patients)
        {
            ...
            File.WriteAllText("../../../Data/PatientInfo/PatientData.json", patientsJson);
        }
        ...
        public static void Block(Patient patient)
        {
            ...
            WriteFile("../../../Data/PatientInfo/PatientData.json", patient, patient);
        }
