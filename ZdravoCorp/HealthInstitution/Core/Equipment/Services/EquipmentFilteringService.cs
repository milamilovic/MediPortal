...
namespace ZdravoCorp.HealthInstitution.Core.Equipment.Services
{
    internal class EquipmentFilteringService
    {
        public static List<EquipmentStorageItem> FilterEquipment(string fileName,
            bool byRoomType, List<Room.Type> roomTypes,
            ...
            bool byQuantity, QuantityRange quantity)
        {
            ...
            if (byRoomType)
            {
                ...
                foreach (Room.Type roomType in roomTypes)
                {
        ...
        public static List<EquipmentStorageItem> FilterByRoomType(ref List<EquipmentStorageItem> items, Room.Type roomType)
        {
            List<EquipmentStorageItem> adequateItems = new List<EquipmentStorageItem>();
            foreach (EquipmentStorageItem item in items)
            {
        ...
        public static Dictionary<string, int> FindItemSumByFilteringRoomType(ref List<EquipmentStorageItem> items, Room.Type roomType)
        {
